...
<br>с 11:00 до 24:00</h5>
        ...
        <div class="hamburger-menu">
            ...
            <ul class="menu__box">
                ...
                <li><a class="menu__item" href="#">Фастфуд</a></li>
                <li><a class="menu__item" href="#">Супы</a></li>
                <li><a class="menu__item" href="#">Салаты</a></li>
...
<!-- Меню боковое -->
        ...
        <div class="conteiner-menu">    
            ...
            <a class="item_menu" href="#"><img class="fastfood"  src="img/burger.png" alt="Фастфуд"> Фастфуд</a>
            <a class="item_menu" href="#"><img class="salats"  src="img/salats.png" alt="Салаты"> Салаты</a>
            <a class="item_menu" href="#"><img class=" sope" src="img/sope.png" alt="Супы"> Супы</a>
            <a class="item_menu" href="#"><img class="food"  src="img/food.png" alt="Горячие блюда"> Горячие блюда</a>
           <a class="item_menu" href="#"><img class="tyahan"  src="img/tyahan.png" alt="Тяхан"> Тяхан</a>
            <a class="item_menu" href="#"><img class="vok" src="img/vok.png" alt="Вок"> Вок</a>
            <a class="item_menu" href="#"><img class="poke" src="img/poke.png" alt="Поке"> Поке</a>
           <a class="item_menu" href="#"><img class="drinks"  src="img/drinks.png" alt="Напитки"> Напитки</a>
